              ...
              <div className="relative">
                <div className="w-full rounded-xl overflow-hidden shadow-2xl shadow-accent-primary/20 border border-accent-primary/20">
                  <ScrollReveal delay={250}>
                     <img src="/images/custom-bar-interior.png" alt="Custom bar interior with warm lighting and wood finishes" className="w-full max-h-64 md:max-h-72 object-cover" loading="lazy" />
                  </ScrollReveal>
                </div>
              </div>
            </ScrollReveal>
                  ...
                  <div className="relative max-sm:mb-2 mb-4">
                    <div className="w-full rounded-lg overflow-hidden shadow-lg">
                      <ScrollReveal delay={index * 100 + 50}>
                        <img src={example.image} alt="Custom craftsmanship and interior design" className={`w-full max-h-64 md:max-h-72 object-cover ${index === 1 ? 'object-bottom' : 'object-center'}`} loading="lazy" />
                      </ScrollReveal>
                    </div>
                  </div>
