          ...
          <div className="flex flex-col items-center space-y-6">
            ...
            <ScrollReveal delay={350}>
              <div className="flex justify-center gap-4">
                ...
                <a href="https://wa.me/353879380494" className="w-12 h-12 rounded-full border border-gray-600 flex items-center justify-center hover:border-white hover:bg-white/10 transition-all duration-300" target="_blank" rel="noopener noreferrer">
                  <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="mailto:tinyacccontracts@gmail.com" className="w-12 h-12 rounded-full border border-gray-600 flex items-center justify-center hover:border-white hover:bg-white/10 transition-all duration-300">
                  <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
