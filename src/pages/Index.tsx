...
const Index = () => {
  ...
  const projects = [{
    ...
    image: '/lovable-uploads/bbb9e0f0-047a-4dd3-9269-37913f6d3ae3.png',
          ...
          <div className="flex flex-col items-center space-y-6">
            ...
            <ScrollReveal delay={350}>
              <div className="flex justify-center gap-4">
                <button onClick={() => scrollToSection('contact-form')} className="w-12 h-12 rounded-full border border-gray-600 flex items-center justify-center hover:border-white hover:bg-white/10 transition-all duration-300">
