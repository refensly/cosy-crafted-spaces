        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="https://wa.me/353879380494" target="_blank" rel="noopener noreferrer nofollow" className="text-gray-400 hover:text-white transition-colors text-sm tracking-wide">WHATSAPP</a></li>
          ...
          <div className="flex flex-col items-center space-y-6">
            ...
            <div className="flex justify-center">
              <a href="https://www.instagram.com/tiny_outdoor_spaces" className="w-12 h-12 rounded-full border border-gray-600 flex items-center justify-center hover:border-white hover:bg-white/10 transition-all duration-300" target="_blank" rel="noopener noreferrer nofollow">
