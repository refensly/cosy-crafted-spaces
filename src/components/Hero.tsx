      ...
      <div className="relative z-30 min-h-screen flex items-center justify-center px-6">
        <div className="text-center max-w-none mx-auto px-4">
          ...
          <div className="space-y-4">
            <Button className="btn-primary text-2xl font-extrabold px-24 py-12 bg-transparent text-white uppercase border-2 border-white hover:bg-white/10 transition-all duration-300 ease-in-out shadow-xl shadow-white/40" style={{boxShadow: '0 0 30px rgba(255, 255, 255, 0.4)'}} onClick={scrollToContact}>
              GET FREE CONSULTATION NOW
            </Button>
            
            {/* Secondary CTAs */}
            <div className="flex gap-4 justify-center mt-6">
              <Button variant="outline" className="border-accent-primary text-white hover:bg-accent-primary/10 px-12 py-6 text-xl">
                INQUIRE
              </Button>
              <Button variant="outline" className="border-accent-primary text-white hover:bg-accent-primary/10 px-12 py-6 text-xl">
                BROWSE
