      ...
      <div className="relative z-30 min-h-screen flex items-center justify-center px-6">
        <div className="text-center max-w-none mx-auto px-4">
          ...
          <p className="text-xl md:text-2xl text-text-secondary mb-8 max-w-2xl mx-auto leading-relaxed">
            <div className="font-body font-bold text-white">Ideal for presents, interior and cozy spaces.</div>
          ...
          <div className="space-y-4">
            <Button className="btn-primary text-2xl font-bold px-24 py-12 bg-black text-white border-2 border-accent-primary hover:bg-transparent transition-all duration-300 ease-in-out shadow-2xl shadow-white/40" onClick={scrollToContact}>
