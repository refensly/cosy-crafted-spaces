...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen bg-bg-main overflow-hidden">
      {/* Left Panel */}
      <div 
        className={`hero-panel absolute top-0 left-0 w-1/2 h-full bg-cover bg-center ${
          panelsOpened ? 'opened' : ''
        }`}
        style={{
      ...
      {/* Right Panel */}
      <div 
        className={`hero-panel absolute top-0 right-0 w-1/2 h-full bg-cover bg-center ${
          panelsOpened ? 'opened' : ''
        }`}
        style={{
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-6">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="font-heading font-bold text-text-primary mb-6 leading-tight">
            Every piece begins where mass production ends.
          </h1>
