...
const Hero = () => {
  ...
  return <section className="relative min-h-screen bg-bg-main overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url('/lovable-uploads/eb697f11-6418-4d33-82da-0298c2d70c59.png')`,
      ...
      <div className="relative z-30 min-h-screen flex items-center justify-center px-6">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            <Button className="btn-primary text-xl px-15 py-8 bg-black text-white border-2 border-white hover:bg-gray-900" onClick={scrollToContact}>
