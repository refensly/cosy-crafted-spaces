      ...
      <div className="relative z-30 min-h-screen flex items-center justify-center px-6">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            <Button className="btn-primary text-2xl font-bold px-32 py-12 bg-black text-white border-2 border-white hover:bg-transparent transition-all duration-300 ease-in-out" onClick={scrollToContact}>
